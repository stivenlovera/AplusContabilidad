            ...
            <Scrollbar style={{
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item sm={6} xs={12}>
                        ...
                        <AppTextField fullWidth size="small" name="categoria" placeholder="Categoria" value={values.storeName} onChange={handleChange} error={Boolean(touched.storeName && errors.storeName)} helperText={touched.storeName && errors.storeName} />
                    </Grid>

                    <Grid item sm={6} xs={12}>
                        <H6 mb={1}>Fecha vencimiento</H6>
                        <AppTextField fullWidth size="small" name="fechaVencimiento" placeholder="Fecha vencimiento" value={values.storeName} onChange={handleChange} error={Boolean(touched.storeName && errors.storeName)} helperText={touched.storeName && errors.storeName} />
                    </Grid>

                    <Grid item sm={6} xs={12}>
                        <H6 mb={1}>Lote</H6>
                        <AppTextField fullWidth size="small" name="lote" placeholder="Lote" value={values.storeName} onChange={handleChange} error={Boolean(touched.storeName && errors.storeName)} helperText={touched.storeName && errors.storeName} />
                    </Grid>

                    <Grid item sm={6} xs={12}>
                        <H6 mb={1}>Unidad Medida</H6>
                        <AppTextField fullWidth size="small" name="unidad" placeholder="Unidad Medida" value={values.storeName} onChange={handleChange} error={Boolean(touched.storeName && errors.storeName)} helperText={touched.storeName && errors.storeName} />
                    </Grid>
                    ...
                    <Grid item sm={6} xs={12}>
                        <H6 mb={1}>Precio venta</H6>
                        <AppTextField fullWidth size="small" name="precioVenta" placeholder="Precio venta" value={values.storeName} onChange={handleChange} error={Boolean(touched.storeName && errors.storeName)} helperText={touched.storeName && errors.storeName} />
                    </Grid>
